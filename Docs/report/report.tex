...
% TODO talk about reactions implementation
...
Graph of how often offered compromises are accepted
...
In order to test the strategic performance of the implementation, the Stockfish API was used to score the move chosen at each turn by the agents. This was repeated over the course of fifty games to account for the randomness used by agents during the choice of action.

Stockfish is one implementation of the universal chess interface and one of the best chess AIs in the world. It uses a complex set of rules to score board positions, which can be used to identify the next best move to make. In our case, we can use it to compare the score of our chosen move and the highest rated score and take the difference as a rating of how good our choice was. 

We then used this metric over many games to produce graphs of our agents performance.

\subsection{User Feedback}

% TODO 
Description of user feedback process
Explanation of questionnaire contents
Results
